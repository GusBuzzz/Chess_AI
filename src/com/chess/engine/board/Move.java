...
public abstract class Move {
    ...
    @Override
    public int hashCode(){ //defined in Java Object class which computes the hash values of given input objects.
        final int prime = 31;
        int result = 1;
    ...
    public static class MajorAttackMove extends AttactMove{
    ...
    public static class AttactMove extends Move{
        final Piece attackedPiece;

        public AttactMove(final Board board,
                   final Piece movedPiece,
                   final int destinationCoordinate,
                   final Piece attackedPiece) {
            super(board, movedPiece, destinationCoordinate);
        ...
        public boolean equals(final Object other){
            ...
            if(!(other instanceof AttactMove)){
                return false;
            }
            final AttactMove otherAttackMove = (AttactMove) other;
    ...
    static abstract class CastelMove extends Move{
        ...
        public boolean equals(final Object other) {
            ...
            final CastelMove otherCastleMove = (CastelMove)other;
